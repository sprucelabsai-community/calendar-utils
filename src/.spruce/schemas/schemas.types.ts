...
declare module '@sprucelabs/spruce-core-schemas/build/.spruce/schemas/core.schemas.types' {
    namespace SpruceSchemas.CalendarUtils.v2021_05_19 {
        ...
        interface EventExclusionDateEntity
            extends SchemaEntity<SpruceSchemas.CalendarUtils.v2021_05_19.EventExclusionDateSchema> {}
    }
    ...
    namespace SpruceSchemas.CalendarUtils.v2021_05_19 {
                ...
                icon: {
                    ...
                    options: {
                        choices: [
                            ...
                            { value: 'edit-box'; label: 'edit-box' },
                            { value: 'location-pin'; label: 'location-pin' },
                            { value: 'refresh'; label: 'refresh' },
                            { value: 'time'; label: 'time' },
                            { value: 'arrow-back'; label: 'arrow-back' },
                            { value: 'clock'; label: 'clock' },
                            { value: 'edit-line'; label: 'edit-line' },
                            ...
                            { value: 'close-circle'; label: 'close-circle' },
                            { value: 'email'; label: 'email' },
                            { value: 'map'; label: 'map' },
                            { value: 'restricted'; label: 'restricted' },
                            { value: 'trending-down'; label: 'trending-down' },
                            { value: 'arrow-down'; label: 'arrow-down' },
                            { value: 'close-square'; label: 'close-square' },
                            { value: 'emoji-happy'; label: 'emoji-happy' },
                            {
                            ...
                            { value: 'arrow-next'; label: 'arrow-next' },
                            { value: 'close'; label: 'close' },
                            { value: 'emoji-sad'; label: 'emoji-sad' },
                            {
                                value: 'message-square'
                                label: 'message-square'
                            },
                            { value: 'search-no'; label: 'search-no' },
                            ...
                            { value: 'fav-heart'; label: 'fav-heart' },
                            { value: 'mic-on'; label: 'mic-on' },
                            {
                            ...
                            { value: 'award-badge'; label: 'award-badge' },
                            {
                                value: 'corner-down-left'
                                label: 'corner-down-left'
                            },
                            { value: 'flip-01'; label: 'flip-01' },
                            ...
                            { value: 'flip-02'; label: 'flip-02' },
                            { value: 'money-sign'; label: 'money-sign' },
                            ...
                            { value: 'help-buoy'; label: 'help-buoy' },
                            ...
                            { value: 'sound-off'; label: 'sound-off' },
                            ...
                            { value: 'sound-on'; label: 'sound-on' },
                            { value: 'chevron-down'; label: 'chevron-down' },
                            { value: 'document-new'; label: 'document-new' },
        ...
        interface CalendarEventLineIconEntity
            extends SchemaEntity<SpruceSchemas.CalendarUtils.v2021_05_19.CalendarEventLineIconSchema> {}
    }
    ...
    namespace SpruceSchemas.CalendarUtils.v2021_05_19 {
        interface EventTimeBlock {
            ...
            rightIcons?:
                | SpruceSchemas.CalendarUtils.v2021_05_19.CalendarEventLineIcon[]
                | undefined
                | null
        ...
        interface EventTimeBlockEntity
            extends SchemaEntity<SpruceSchemas.CalendarUtils.v2021_05_19.EventTimeBlockSchema> {}
    }
    ...
    namespace SpruceSchemas.CalendarUtils.v2021_05_19 {
        ...
        interface CalendarEventTargetEntity
            extends SchemaEntity<SpruceSchemas.CalendarUtils.v2021_05_19.CalendarEventTargetSchema> {}
    }
    ...
    namespace SpruceSchemas.CalendarUtils.v2021_05_19 {
        interface CalendarEvent {
            ...
            exclusionDates?:
                | SpruceSchemas.CalendarUtils.v2021_05_19.EventExclusionDate[]
                | undefined
                | null
        ...
        interface CalendarEventEntity
            extends SchemaEntity<SpruceSchemas.CalendarUtils.v2021_05_19.CalendarEventSchema> {}
    }
}
